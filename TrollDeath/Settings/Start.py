...
def Clear_1():
    if platform.system() == 'Windows':
        os.system('cls & title Welcom To Lynx1')  # Clear_1 console, change title
...
while True:
   ...
   print(f"""{popup_version}{red}                                                                                                   ⠀⠀⠀                     
                         ...
                         \__$$  __|                 $$ |$$ |$$  __$$\                      $$ |    $$ |      
                            ...
                            $$ |$$ |      $$ |  $$ |$$ |$$ |$$ |  $$ |$$   ____|$$  __$$ | $$ |$$\ $$ |  $$ |
                            $$ |$$ |      \$$$$$$  |$$ |$$ |$$$$$$$  |\$$$$$$$\ \$$$$$$$ | \$$$$  |$$ |  $$ |
                            \__|\__|       \______/ \__|\__|\_______/  \_______| \_______|  \____/ \__|  \__|
                                                                                    
                                                      
                                  DEV BY  :  Lynx1 / youtube : https://www.youtube.com/@Troll_death
                                  Discord : Pheanomenal  / insta : skull.py       
